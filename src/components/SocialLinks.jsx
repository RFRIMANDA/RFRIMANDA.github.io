...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/rifky-frimanda-71863a308/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@rifkyfrimanda_",
    icon: Instagram,
    url: "https://www.instagram.com/rifkyfrimanda_/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Rifky Frimanda",
    icon: Youtube,
    url: "https://www.youtube.com/@rifkyfrimanda",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Rifkyfrimanda",
    icon: Github,
    url: "https://github.com/RFRIMANDA",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@404dekonggg",
    color: "black",
